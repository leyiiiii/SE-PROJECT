    ...
    <el-row>
        ...
        <el-col :span="22"><div class="Right">
            ...
            <el-row class="cardsRow">
                <el-col :span="7" v-for="item in invitationList" :key="item.id">
                    <div class="recoveryCard">
                    <el-card :body-style="{ padding: '0px' }" shadow="hover">
                    <img src="@/assets/Invite2.png" class="image">
                    <div style="padding: 14px;">
                        <span class="cardTeam">{{ item.team }}</span>
                        <div class="bottom clearfix">
                        <time class="type">- {{ item.invitedBy }}邀请您进入团队</time>
                        <el-button type="danger" plain class="button1" @click="Accept(item.id)">同意</el-button>
                        <el-button type="success" plain class="button2" @click="Decline(item.id)">拒绝</el-button>
                        </div>
                    </div>
                    </el-card>
                    </div>
            ...
            <el-row>
                <div class="container" v-if="invitationList.length == 0">
